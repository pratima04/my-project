...
<section class="form-container">
    <form action="" method="post">
        <h3>Your Address</h3>
        <input type="text" class="box" placeholder="flat no. and building name" 
        required maxlength="50" name="flat">
        ...
        <input type="text" class="box" placeholder="state name" required 
        maxlength="50" name="state">
        <input type="text" class="box" placeholder="country name" required 
        maxlength="50" name="country">
        <input type="text" class="box" placeholder="pin code" required 
        max="999999" min="0" onkeydown="if(this.value.length == 6) return false;" 
        name="pin code">
